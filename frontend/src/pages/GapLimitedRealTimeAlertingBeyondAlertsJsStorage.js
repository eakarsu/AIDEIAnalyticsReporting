...
/**
 * Gap/CFS Feature Page: Limited real-time alerting beyond `alerts.js` storage.
 * Slug: limited-real-time-alerting-beyond-alerts-js-storage
 * Backend: /api/gap-limited-real-time-alerting-beyond-alerts-js-storage
 */
export default function LimitedRealTimeAlertingBeyondAlertsJsStoragePage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-limited-real-time-alerting-beyond-alerts-js-storage', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Limited real-time alerting beyond `alerts.js` storage.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Limited real-time alerting beyond `alerts.js` storage.</p>
