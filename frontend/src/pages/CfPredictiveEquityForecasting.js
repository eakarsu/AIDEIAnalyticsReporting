...
/**
 * Gap/CFS Feature Page: Predictive equity forecasting
 * Slug: predictive-equity-forecasting
 * Backend: /api/cf-predictive-equity-forecasting
 */
export default function PredictiveEquityForecastingPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-predictive-equity-forecasting', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Predictive equity forecasting</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>ML model forecasts future pay equity/diversity given current trends; recommend interventions.</p>
