...
/**
 * Gap/CFS Feature Page: Limited HRIS integration — no Workday/SuccessFactors/BambooHR adapter.
 * Slug: limited-hris-integration-no-workday-successfactors-bamboohr
 * Backend: /api/gap-limited-hris-integration-no-workday-successfactors-bamboohr
 */
export default function LimitedHrisIntegrationNoWorkdaySuccessfactorsBamboohrPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-limited-hris-integration-no-workday-successfactors-bamboohr', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Limited HRIS integration — no Workday/SuccessFactors/BambooHR adapter.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Limited HRIS integration — no Workday/SuccessFactors/BambooHR adapter.</p>
