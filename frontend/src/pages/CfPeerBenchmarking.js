...
/**
 * Gap/CFS Feature Page: Peer benchmarking
 * Slug: peer-benchmarking
 * Backend: /api/cf-peer-benchmarking
 */
export default function PeerBenchmarkingPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-peer-benchmarking', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Peer benchmarking</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Compare organization DEI metrics to peer group; identify best practices.</p>
