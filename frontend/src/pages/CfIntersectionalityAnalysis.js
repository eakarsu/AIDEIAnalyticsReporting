...
/**
 * Gap/CFS Feature Page: Intersectionality analysis
 * Slug: intersectionality-analysis
 * Backend: /api/cf-intersectionality-analysis
 */
export default function IntersectionalityAnalysisPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-intersectionality-analysis', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Intersectionality analysis</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Analyze DEI metrics across multiple identity dimensions; identify overlooked inequities.</p>
