...
/**
 * Gap/CFS Feature Page: Talent pipeline simulation
 * Slug: talent-pipeline-simulation
 * Backend: /api/cf-talent-pipeline-simulation
 */
export default function TalentPipelineSimulationPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-talent-pipeline-simulation', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Talent pipeline simulation</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Model impact of hiring/promotion policy changes on future diversity/equity.</p>
